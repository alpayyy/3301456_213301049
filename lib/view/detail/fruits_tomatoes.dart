...
class FruitsTomatoes extends StatefulWidget {
  const FruitsTomatoes({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _FruitsTomatoesState createState() => _FruitsTomatoesState();
}

class _FruitsTomatoesState extends State<FruitsTomatoes> {
  int count = 1;
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const TextMedium(
                      text: FruitConst.tomatoes_subtitle,
                    ),
                    FruitConst.sizedBoxHeight10,
                    const TextSmall(
                      text: FruitConst.tomatoes_context,
                    ),
                    FruitConst.sizedBoxHeight20,
                    const TextMedium(
                      text: FruitConst.tomatoes_subtitletwo,
                    ),
                    FruitConst.sizedBoxHeight10,
