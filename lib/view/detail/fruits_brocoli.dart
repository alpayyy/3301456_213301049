...
class FruitsBrocoli extends StatefulWidget {
  const FruitsBrocoli({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _FruitsBrocoliState createState() => _FruitsBrocoliState();
}

class _FruitsBrocoliState extends State<FruitsBrocoli> {
  int count = 1;
