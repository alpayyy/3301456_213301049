...
class FruitsPotato extends StatefulWidget {
  const FruitsPotato({Key? key}) : super(key: key);

  @override
  // ignore: library_private_types_in_public_api
  _FruitsPotatoState createState() => _FruitsPotatoState();
}

class _FruitsPotatoState extends State<FruitsPotato> {
  int count = 1;
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const TextMedium(
                      text: FruitConst.potato_subtitle,
                    ),
                    FruitConst.sizedBoxHeight10,
                    const TextSmall(
                      text: FruitConst.potato_context,
                    ),
                    FruitConst.sizedBoxHeight20,
                    const TextMedium(
                      text: FruitConst.potato_subtitletwo,
                    ),
                    FruitConst.sizedBoxHeight10,
